...
from app.routers import auth, capacity, client_stf, daily, dashboard, ltf, markets, overtime, recruitment, scheduling, settings as settings_router, stf, shrinkage
