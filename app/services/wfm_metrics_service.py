    ...
    if not intervals:
        return WFMScorecard(
            ...
            operations=OperationsScorecard(
                ...
                scheduled_asa_seconds=None,
                actual_asa_seconds=None,
                asa_target_seconds=asa_target_seconds,
                asa_gap_seconds=None,
                scheduled_occupancy_pct=0,
                occupancy_pct=None,
                occupancy_target_pct=occupancy_target_pct or 0,
                occupancy_gap_pct=None,
                abandon_rate_pct=None,
                workload_hours=None,
                utilization_pct=None,
                schedule_efficiency_pct=0,
            ),
            alerts=[],
        )
